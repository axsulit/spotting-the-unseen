...
class TrainOptions(BaseOptions):
    """
    Options used during training. Extends BaseOptions with training-specific arguments.
    """
    
    def initialize(self, parser):
        """
        Define training-specific options and set training flag to True.

        Args:
            parser: ArgumentParser object to which arguments are added.

        Returns:
            parser: Updated ArgumentParser with training options.
        """
